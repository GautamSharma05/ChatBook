package com.example.chatbook.Adapter;
...
import com.example.chatbook.databinding.ItemRecieveBinding;
import com.example.chatbook.databinding.ItemSendBinding;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        ReactionPopup popup = new ReactionPopup(context, config, (pos) -> {
            if (holder.getClass() == SentViewHolder.class){
                ...
                viewHolder.binding.sendFeeling.setImageResource(reactions[pos]);
                viewHolder.binding.sendFeeling.setVisibility(View.VISIBLE);
            }
            else {
        ...
        if (holder.getClass() == SentViewHolder.class){
            ...
            if(message.getFeeling() >= 0){
                ...
                viewHolder.binding.sendFeeling.setImageResource(reactions[message.getFeeling()]);
                viewHolder.binding.sendFeeling.setVisibility(View.VISIBLE);

            }else {
                viewHolder.binding.sendFeeling.setVisibility(View.GONE);
            }
